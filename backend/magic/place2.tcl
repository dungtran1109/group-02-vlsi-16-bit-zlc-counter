# Fixed: use LAMBDA units (= internal/2)
set OR2  268
set INV  176
set AND2 268
set MUX2 452
...
for {set i 0} {$i < 4} {incr i} {
    set x [place or2_1 $x $y]; set x [place inv_1 $x $y]
}
puts "Row 1: $x"
...
for {set i 0} {$i < 2} {incr i} {
    set x [place or2_1 $x $y]; set x [place inv_1 $x $y]; set x [place mux2_1 $x $y]
}
puts "Row 3: $x"
...
for {set i 0} {$i < 2} {incr i} {
    set x [place or2_1 $x $y]; set x [place inv_1 $x $y]
    set x [place mux2_1 $x $y]; set x [place mux2_1 $x $y]
}
puts "Row 5: $x"

set x 0; set y [expr 5*$ROW]
set x [place or2_1 $x $y]; set x [place inv_1 $x $y]
for {set i 0} {$i < 3} {incr i} { set x [place mux2_1 $x $y] }
puts "Row 6: $x"

set x 0; set y [expr 6*$ROW]
set x [place inv_1 $x $y]
for {set i 0} {$i < 4} {incr i} { set x [place and2_1 $x $y] }
puts "Row 7: $x"
