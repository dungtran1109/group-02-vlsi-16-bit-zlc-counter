...
N 0 90 230 90 {lab=P}
C {sky130_stdcells/or2_1.sym} -30 -20 0 0 {name=x1 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
...
C {ipin.sym} -290 60 0 0 {name=p5 lab=VDD}
C {ipin.sym} -290 100 0 0 {name=p6 lab=GND}
